...
def template_monte_carlo_sim():
    ...
    sim = MCSim(name='Coin Flip', ndraws=ndraws, fcns=fcns, firstcaseisnom=firstcaseisnom, seed=seed, cores=cores, savecasedata=savecasedata, savesimdata=savesimdata, verbose=True, debug=False)
