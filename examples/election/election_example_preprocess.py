def election_example_preprocess(case):
    ...
    for state in states:
        total_pct =   case.invals[f'{state} Dem Unscaled Pct'].val \
        ...
        state_dem_pct[state] = case.invals[f'{state} Dem Unscaled Pct'].val / total_pct \
                               + case.invals['National Dem Swing'].val
        state_rep_pct[state] = case.invals[f'{state} Rep Unscaled Pct'].val / total_pct \
                               - case.invals['National Dem Swing'].val
