...
fcns = {
    "preprocess": election_example_preprocess,
...
def election_example_monte_carlo_sim():
    ...
    sim.outvars["Dem EVs"].addVarStat(stat="orderstatP", statkwargs={"p": 0.5, "bound": "nearest"})
    sim.outvars["Dem EVs"].addVarStat(
        stat="orderstatTI", statkwargs={"p": 0.75, "c": 0.90, "bound": "2-sided"}
    )
