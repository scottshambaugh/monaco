...
def test_hash_str_repeatable():
    assert (
        hash_str_repeatable("test")
        == 12472987081885563334685425079619105233668272366527481043458243581788592708023738622989151050329990942934984448616851791396966092833116143876347600403212543
    )  # noqa: E501
